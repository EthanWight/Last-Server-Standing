...
Once the server falls, the network collapses — so defend it at all costs!
...
- USB Debugging enabled if using a device  
- `google-services.json` in `/app` (if using Firebase)
